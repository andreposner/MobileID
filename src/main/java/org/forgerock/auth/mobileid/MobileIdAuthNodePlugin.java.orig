 ...
 * @since AM 5.5.0
 */
public class MobileIdAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(MobileIdAuthNodePlugin.currentVersion, 
				Collections.singletonList(MobileIdAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return MobileIdAuthNodePlugin.currentVersion;
	}
}
